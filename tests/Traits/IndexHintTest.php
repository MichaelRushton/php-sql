...
test("use index", function ($index, $output)
{
  ...
  expect((string) SQL::MariaDB->table("t1")->useIndex($index))
...
test("use index for order by", function ($index, $output)
{
  ...
  expect((string) SQL::MariaDB->table("t1")->useIndexForOrderBy($index))
...
test("use index for group by", function ($index, $output)
{
  ...
  expect((string) SQL::MariaDB->table("t1")->useIndexForGroupBy($index))
...
test("ignore index", function ($index, $output)
{
  ...
  expect((string) SQL::MariaDB->table("t1")->ignoreIndex($index))
...
test("ignore index for order by", function ($index, $output)
{
  ...
  expect((string) SQL::MariaDB->table("t1")->ignoreIndexForOrderBy($index))
...
test("ignore index for group by", function ($index, $output)
{
  ...
  expect((string) SQL::MariaDB->table("t1")->ignoreIndexForGroupBy($index))
...
test("force index", function ($index, $output)
{
  ...
  expect((string) SQL::MariaDB->table("t1")->forceIndex($index))
...
test("force index for order by", function ($index, $output)
{
  ...
  expect((string) SQL::MariaDB->table("t1")->forceIndexForOrderBy($index))
...
test("force index for group by", function ($index, $output)
{
  ...
  expect((string) SQL::MariaDB->table("t1")->forceIndexForGroupBy($index))
