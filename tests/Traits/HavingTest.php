...
->with([
  ...
  [true, "?", [true]],
  [null, "NULL"],
  [["c1" => 1, "c2" => "test"], '"c1" = 1 AND NOT "c2" = ?', ["test"]],
  [fn (Having $having) => $having->having(true), "?", [true]],
]);
...
->with([
  ...
  [true, "?", [true]],
  [null, "NULL"],
  [["c1" => 1, "c2" => "test"], '"c1" = 1 OR NOT "c2" = ?', ["test"]],
  [fn (Having $having) => $having->having(true), "?", [true]],
]);
...
->with([
  ...
  [1, 2, 3, "1 BETWEEN 2 AND 3"],
  [1.1, 2.2, 3.3, "1.1 BETWEEN 2.2 AND 3.3"],
]);
